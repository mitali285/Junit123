...
public class CoffeeVendingMachineSwitches {
	Logger logger = Logger.getLogger(CoffeeVendingMachineSwitches.class.getName());

	Container containers = new Container();
	VendingMachineOperationOnDrinkImpl machine = new VendingMachineOperationOnDrinkImpl();
